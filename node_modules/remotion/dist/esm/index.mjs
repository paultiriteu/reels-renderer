...
// src/Composition.tsx
import { Suspense, useCallback as useCallback7, useContext as useContext18, useEffect as useEffect3 } from "react";
...
var getSingleChildComponent = (children) => {
  const mountedChildren = React4.Children.toArray(children);
...
// src/freeze.tsx
import { useContext as useContext13, useMemo as useMemo10 } from "react";

// src/SequenceContext.tsx
import { createContext as createContext8 } from "react";
var SequenceContext = createContext8(null);
...
import { createContext as createContext10, useCallback as useCallback2, useContext as useContext6 } from "react";
...
import { useContext as useContext5, useState } from "react";

// src/remotion-environment-context.ts
import React6 from "react";
var RemotionEnvironmentContext = React6.createContext(null);

// src/use-remotion-environment.ts
var useRemotionEnvironment = () => {
  const context = useContext5(RemotionEnvironmentContext);
...
var useDelayRender = () => {
  ...
  const scope = useContext6(DelayRenderContextType) ?? (typeof window !== "undefined" ? window : undefined);
...
var SetTimelineContext = createContext11({
  setFrame: () => {
...
var PlaybackRateContext = createContext11(null);
var AbsoluteTimeContext = createContext11(null);
var TimelineContextProvider = ({ children, frameState }) => {
  ...
  const timelineContextValue = useMemo4(() => {
    return {
      frame,
      playing,
      imperativePlaying,
  ...
  const playbackRateContextValue = useMemo4(() => {
    return {
      playbackRate,
      setPlaybackRate
    };
  }, [playbackRate]);
  const setTimelineContextValue = useMemo4(() => {
    return {
      setFrame,
      setPlaying
    };
  }, []);
  return /* @__PURE__ */ jsx5(AbsoluteTimeContext.Provider, {
    value: timelineContextValue,
    children: /* @__PURE__ */ jsx5(PlaybackRateContext.Provider, {
      value: playbackRateContextValue,
      children: /* @__PURE__ */ jsx5(TimelineContext.Provider, {
        value: timelineContextValue,
...
import { createContext as createContext13, createRef, useContext as useContext7, useMemo as useMemo6 } from "react";
...
// src/EditorProps.tsx
import React8, { createContext as createContext12, useCallback as useCallback3, useMemo as useMemo5 } from "react";
import { jsx as jsx6 } from "react/jsx-runtime";
var EditorPropsContext = createContext12({
  props: {},
  updateProps: () => {
    throw new Error("Not implemented");
  }
});
var timeValueRef = React8.createRef();
var EditorPropsProvider = ({ children }) => {
  const [props, setProps] = React8.useState({});
  const updateProps = useCallback3(({
    defaultProps,
    id,
    newProps
  }) => {
...
// src/ResolveCompositionConfig.tsx
var ResolveCompositionContext = createContext13(null);
var resolveCompositionsRef = createRef();
var needsResolution = (composition) => {
  return Boolean(composition.calculateMetadata);
};
var useResolvedVideoConfig = (preferredCompositionId) => {
  const context = useContext7(ResolveCompositionContext);
  const { props: allEditorProps } = useContext7(EditorPropsContext);
  const { compositions, canvasContent, currentCompositionMetadata } = useContext7(CompositionManager);
  const currentComposition = canvasContent?.type === "composition" ? canvasContent.compositionId : null;
  const compositionId = preferredCompositionId ?? currentComposition;
  const composition = compositions.find((c) => c.id === compositionId);
  const selectedEditorProps = useMemo6(() => {
...
var useTimelineContext = () => {
  const state = useContext9(TimelineContext);
  if (state === null) {
...
var usePlaybackRate = () => {
  const state = useContext9(PlaybackRateContext);
  if (state === null) {
...
var useAbsoluteTimelinePosition = () => {
  const state = useContext9(AbsoluteTimeContext);
  if (state === null) {
...
var useTimelineSetFrame = () => {
  const { setFrame } = useContext9(SetTimelineContext);
  return setFrame;
};
var usePlayingState = () => {
  const { playing, imperativePlaying } = useTimelineContext();
  const { setPlaying } = useContext9(SetTimelineContext);
  return useMemo8(() => [playing, setPlaying, imperativePlaying], [imperativePlaying, playing, setPlaying]);
};
...
var useVideoConfig = () => {
  ...
  const context = useContext12(CanUseRemotionHooks);
...
var Freeze = ({
  ...
  const sequenceContext = useContext13(SequenceContext);
...
import React10, { useCallback as useCallback4, useMemo as useMemo11, useRef as useRef3, useState as useState3 } from "react";
...
var SequenceManagerRefContext = React10.createContext({
  current: []
});
...
var VisualModePropStatusesContext = React10.createContext({
  propStatuses: {}
});
var VisualModePropStatusesRefContext = React10.createContext({
  current: {}
});
...
var SequenceManagerProvider = ({ children }) => {
  ...
  const setDragOverrides = useCallback4((nodePath, key, value) => {
  ...
  const clearDragOverrides = useCallback4((nodePath) => {
    setControlOverrides((prev) => {
  ...
  const setEffectDragOverrides = useCallback4((nodePath, effectIndex, key, value) => {
  ...
  const clearEffectDragOverrides = useCallback4((nodePath, effectIndex) => {
    setEffectDragOverridesState((prev) => {
      const mapKey = effectDragOverridesKey(nodePath, effectIndex);
      if (!prev[mapKey]) {
        return prev;
  ...
  const setPropStatuses = useCallback4((nodePath, values) => {
  ...
  const getDragOverrides = useCallback4((nodePath) => {
    return dragOverrides[makeSequencePropsSubscriptionKey(nodePath)] ?? {};
  }, [dragOverrides]);
  const getEffectDragOverrides = useCallback4((nodePath, effectIndex) => {
  ...
  return /* @__PURE__ */ jsx8(SequenceManagerRefContext.Provider, {
    value: sequencesRef,
    children: /* @__PURE__ */ jsx8(SequenceManager.Provider, {
      value: sequenceContext,
      children: /* @__PURE__ */ jsx8(VisualModePropStatusesRefContext.Provider, {
        value: propStatusesRef,
        children: /* @__PURE__ */ jsx8(VisualModePropStatusesContext.Provider, {
          value: propStatusesContext,
          children: /* @__PURE__ */ jsx8(VisualModeDragOverridesContext.Provider, {
            value: dragOverridesContext,
            children: /* @__PURE__ */ jsx8(VisualModeSettersContext.Provider, {
...
import React11, { createContext as createContext14 } from "react";
import { jsx as jsx9 } from "react/jsx-runtime";
var IsInsideSeriesContext = createContext14(false);
var IsInsideSeriesContainer = ({ children }) => {
  return /* @__PURE__ */ jsx9(IsInsideSeriesContext.Provider, {
    value: true,
    children
  });
};
...
var useRequireToBeInsideSeries = () => {
  const isInsideSeries = React11.useContext(IsInsideSeriesContext);
  if (!isInsideSeries) {
...
import { useContext as useContext14, useMemo as useMemo12 } from "react";
...
var usePremounting = ({
  ...
  const parentPremountContext = useContext14(PremountContext);
...
import { useContext as useContext15, useRef as useRef4 } from "react";
...
var RegularSequenceRefForwardingFunction = ({
  ...
  const wrapperRefForOutline = useRef5(null);
  ...
  const frozenContent = content === null || typeof freeze === "undefined" || freeze === null ? content : /* @__PURE__ */ jsx10(Freeze, {
    frame: freeze,
    children: content
  });
  ...
  const sequenceRef = useCallback5((node) => {
  ...
  return /* @__PURE__ */ jsx10(SequenceContext.Provider, {
    value: contextValue,
    children: frozenContent === null ? null : other.layout === "none" ? frozenContent : /* @__PURE__ */ jsx10(AbsoluteFillElement, {
      ref: sequenceRef,
      style: defaultStyle,
      className: other.className,
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return /* @__PURE__ */ jsx10(Freeze, {
    frame: freezeFrame,
    active: isPremountingOrPostmounting,
    children: /* @__PURE__ */ jsx10(SequenceInner, {
      ref,
      from,
      durationInFrames,
...
var SequenceRefForwardingFunction = (props, ref) => {
  ...
  if (props.layout !== "none" && !env.isRendering) {
    ...
    if (effectivePremountFor || props.postmountFor) {
      return /* @__PURE__ */ jsx10(PremountedPostmountedSequence, {
        ref,
        ...props,
  ...
  return /* @__PURE__ */ jsx10(RegularSequence, {
    ...props,
    ref
  });
};
...
var AbsoluteFillInner = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const refForOutline = useRef6(null);
  const callbackRef = useCallback6((element) => {
    refForOutline.current = element;
    setRef(ref, element);
  }, [ref]);
  if (videoConfig === null) {
    return hidden ? null : /* @__PURE__ */ jsx11(AbsoluteFillElement, {
      ref: callbackRef,
      ...divProps,
      children
    });
  }
  return /* @__PURE__ */ jsx11(Sequence, {
    layout: "none",
    from: from ?? 0,
    trimBefore,
    freeze,
    ...
    children: /* @__PURE__ */ jsx11(AbsoluteFillElement, {
      ref: callbackRef,
      ...divProps,
      children
    })
...
import React15, { useMemo as useMemo15, useRef as useRef7 } from "react";
var useLazyComponent = ({
  compProps,
  componentName,
  noSuspense
}) => {
  const componentRef = useRef7(null);
  if ("component" in compProps) {
    componentRef.current = compProps.component;
  }
  const lazy = useMemo15(() => {
    if ("component" in compProps) {
      ...
      const Wrapper = (props) => {
        ...
        return React15.createElement(Comp, props);
      };
      return Wrapper;
    }
    if ("lazyComponent" in compProps && typeof compProps.lazyComponent !== "undefined") {
      ...
      return React15.lazy(compProps.lazyComponent);
    }
...
var InnerComposition = ({
  ...
  const compManager = useContext18(CompositionSetters);
  ...
  const isPlayer = useIsPlayer();
  const environment = useRemotionEnvironment();
  const canUseComposition = useContext18(CanUseRemotionHooks);
  if (typeof window !== "undefined") {
  ...
  const { folderName, parentName } = useContext18(FolderContext);
  ...
  const { setError, clearError } = useContext18(CompositionRenderErrorContext);
  const onError = useCallback7((error2) => {
    setError(error2);
  }, [setError]);
  const onClear = useCallback7(() => {
    clearError();
  }, [clearError]);
  if (environment.isStudio && video && video.component === lazy && video.id === id) {
    ...
    return createPortal(/* @__PURE__ */ jsx13(CanUseRemotionHooksProvider, {
      children: /* @__PURE__ */ jsx13(CompositionErrorBoundary, {
        onError,
        onClear,
        children: /* @__PURE__ */ jsx13(Suspense, {
          fallback: /* @__PURE__ */ jsx13(Loading, {}),
          children: /* @__PURE__ */ jsx13(Comp, {
  ...
  if (environment.isRendering && video && video.component === lazy && video.id === id) {
    ...
    return createPortal(/* @__PURE__ */ jsx13(CanUseRemotionHooksProvider, {
      children: /* @__PURE__ */ jsx13(Suspense, {
        fallback: /* @__PURE__ */ jsx13(Fallback, {}),
        children: /* @__PURE__ */ jsx13(Comp, {
          ...resolved.result.props ?? {}
        })
      })
...
var Composition = (props) => {
  const { onlyRenderComposition } = useContext18(CompositionSetters);
  if (onlyRenderComposition && onlyRenderComposition !== props.id) {
    return null;
  }
  return /* @__PURE__ */ jsx13(InnerComposition, {
    ...props
  });
};
...
import { useContext as useContext22, useLayoutEffect as useLayoutEffect5, useRef as useRef15 } from "react";
...
var SequenceStackTracesUpdateContext = React35.createContext(() => {});
...
import React36, { createContext as createContext25 } from "react";
var CurrentScaleContext = React36.createContext(null);
...
var useCurrentScale = (options) => {
  const hasContext = React36.useContext(CurrentScaleContext);
  const zoomContext = React36.useContext(PreviewSizeContext);
...
import React37, { useContext as useContext36 } from "react";
var PixelDensityContext = React37.createContext(null);
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  ...
  const effectToUse = React39.useInsertionEffect ?? React39.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
...
import React41, { useMemo as useMemo39 } from "react";
...
function useRemotionContexts() {
  ...
  const canUseRemotionHooksContext = React41.useContext(CanUseRemotionHooks);
  const preloadContext = React41.useContext(PreloadContext);
  const resolveCompositionContext = React41.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = React41.useContext(RenderAssetManager);
  const sequenceManagerContext = React41.useContext(SequenceManager);
  const sequenceManagerRefContext = React41.useContext(SequenceManagerRefContext);
  const visualModePropStatusesRefContext = React41.useContext(VisualModePropStatusesRefContext);
  const bufferManagerContext = React41.useContext(BufferingContextReact);
  const logLevelContext = React41.useContext(LogLevelContext);
  return useMemo39(() => ({
...
var flattenChildren = (children) => {
  ...
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === React42.Fragment) {
...
var SeriesInner = (props2) => {
  const childrenValue = useMemo40(() => {
    ...
    const renderChildren = (i, startFrame) => {
      ...
      return React43.cloneElement(castedElement, {
  ...
  return /* @__PURE__ */ jsx38(IsInsideSeriesContainer, {
    children: /* @__PURE__ */ jsx38(Sequence, {
      layout: "none",
      name: "<Series>",
...
var Still = (props2) => {
  ...
  return React44.createElement(Composition, newProps);
};
